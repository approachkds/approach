...
public class Paging {
	...
	// 3. int recordPerPage;	// 한 페이지당 게시물 개수 (게시판마다 한 페이지에 표시할 목록의 개수를 다르게 설정하기 위해서 받아온다.)
	...
	public static String getPaging(String path, int totalRecord, int recordPerPage, int page) {
		...
		*/
		...
		// 페이지 5개를 한 블록에 배치
		int pagePerBlock = 5;	// 한 블록당 페이지 5개ㅔ
		...
		/* 
			...
			/MyHome/queryBoardListPage.board?columne=BTITLE&query=검색어 &page=1
		*/
